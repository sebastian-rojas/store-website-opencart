...
<div class="content">
    <div class="key_header">
      <h1>16 Key Features Of Grace Premium Theme</h1>
      <a href="http://www.ashertheme.com/downloads/grace-opencart-pro-theme/" class="activate_now">Click Here To Buy Now</a> </div>
    <table class="pro_modules">
      <thead>
        <tr>
          <th>Serial No.</th>
          <th>Free Modules with Premium Theme</th>
          <th>Example</th>
          <th>Features</th>
          <th>Included</th>
        </tr>
      ...
      <tbody>
        <tr>
          <td>1</td>
          <td>Advanced Grid</td>
          <td><img src="view/image/m1.jpg" /></td>
          <td>You can create various grids with custom templates and advanced configuration. You can decide if you want to display html content, links, products, newsletter or something more. You can also load other module as the element of the column in grid.</td>
          <td></td>
        </tr>
        <tr>
          <td>2</td>
          <td>Breadcrumb Background Image</td>
          <td><img src="view/image/m2.jpg" /></td>
          <td>Module allow you to upload own background photo for breadcrumb.</td>
          <td></td>
        </tr>
        <tr>
          <td>3</td>
          <td>Camera slider</td>
          <td><img src="view/image/m3.jpg" /></td>
          <td>Simpliest slider module we have in our theme.</td>
          <td></td>
        </tr>
        <tr>
          <td>4</td>
          <td>Carousel item</td>
          <td><img src="view/image/m4.jpg" /></td>
          <td>Create content with HTML content and put it in carousel.</td>
          <td></td>
        </tr>
        <tr>
          <td>5</td>
          <td>Category Wall</td>
          <td><img src="view/image/m5.jpg" /></td>
          <td>We can display all of our categories in the form of wall on front page or any of the pages in the site with images, increases user experience to select specific category or subcategory of their choice.</td>
          <td></td>
        </tr>
        <tr>
          <td>6</td>
          <td>Cosmos theme options</td>
          <td><img src="view/image/m6.jpg" /></td>
          <td>Theme options allow you to resize your site with full width or box width and has the ability to change zoom options in the product page, header, set social media links and custom footer etc.</td>
          <td></td>
        </tr>
        <tr>
          <td>7</td>
          <td>Custom Module</td>
          <td><img src="view/image/m7.jpg" /></td>
          <td>Create extra content with anything you want. You can use HTML or set just text, image, video or other media.</td>
          <td></td>
        </tr>
        <tr>
          <td>8</td>
          <td>Full screen background slider</td>
          <td><img src="view/image/m8.jpg" /></td>
          <td>Nice slider in the background of your store. It’s very easy to use because it works exactly the same like camera slider.</td>
          <td></td>
        </tr>
        <tr>
          <td>9</td>
          <td>Filter product</td>
          <td><img src="view/image/m9.jpg" /></td>
          <td>Product modules with scroll or tabs. In our pre-made skins Filter Product was used to build almost all product modules.</td>
          <td></td>
        </tr>
        <tr>
          <td>10</td>
          <td>Header Notice</td>
          <td><img src="view/image/m10.jpg" /></td>
          <td>Simple header notification with HTML content.</td>
          <td></td>
        </tr>
        <tr>
          <td>11</td>
          <td>MegaMenu Manager Links</td>
          <td><img src="view/image/m11.jpg" /></td>
          <td>Manage Megamenu items.</td>
          <td></td>
        </tr>
        <tr>
          <td>12</td>
          <td>MegaMenu</td>
          <td><img src="view/image/m12.jpg" /></td>
          <td>Own MegaMenu instead of default submenu.</td>
          <td></td>
        </tr>
        <tr>
          <td>13</td>
          <td>Product Blocks</td>
          <td><img src="view/image/m13.jpg" /></td>
          <td>Extra modules on the product page. All additional modules on product pages in our theme were created with Product Blocks.</td>
          <td></td>
        </tr>
        <tr>
          <td>14</td>
          <td>Product tabs</td>
          <td><img src="view/image/m14.jpg" /></td>
          <td>You can create extra tabs on the product page.</td>
          <td></td>
        </tr>
        <tr>
          <td>15</td>
          <td>Revolution Slider Output</td>
          <td><img src="view/image/m15.jpg" /></td>
          <td>It used to display revolution slider postions and places to display like home page or category pages.</td>
          <td></td>
        </tr>
        <tr>
          <td>16</td>
          <td>Revolution Slider</td>
          <td><img src="view/image/m16.jpg" /></td>
          <td>Powerfull slider module.</td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td><a href="http://www.ashertheme.com/downloads/grace-opencart-pro-theme/" class="activate_now">Click Here To Buy Now</a></td>
          <td></td>
          <td></td>
        </tr>
      </tbody>
